...
private:
  ...
  rclcpp::Service<GetHandToTargetCoord>::SharedPtr service_server_move_hand_to_coord_;
  rclcpp::Service<GetHandToTargetTF>::SharedPtr service_server_move_hand_to_tf_;
  ...
  void serve_move_hand_to_coord(const std::shared_ptr<GetHandToTargetCoord::Request> request, std::shared_ptr<GetHandToTargetCoord::Response> response);
  void serve_move_hand_to_tf(const std::shared_ptr<GetHandToTargetTF::Request> request, std::shared_ptr<GetHandToTargetTF::Response> response);
...
RCLCPP_COMPONENTS_REGISTER_NODE(hsr_sim::JointActionServer)
